...
<template>
    ...
    <div class="flex flex-col">
            ...
            <div class="flex flex-col container p-10 mx-auto" v-show="!island_is_set">
                ...
                <div class="mx-auto" v-show="!island_is_set">
                    <form @submit.prevent="set_island" class="flex flex-col md:flex-row space-y-2 md:space-x-4 md:space-y-0">
                        ...
                        <div class="mx-auto">
                            <button type="submit" class="bg-green-100 px-2 py-1 border-2 border-green-400 rounded-2xl text-green-500">Set Location</button>
                        </div>
                    </form>
                </div>
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                ...
                <div class="m-2">
                    <div class="flex">
                        ...
                        <button class=" px-2 py-1 border-blue-800 rounded-full text-blue-800 " @click="set_list"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
      <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
    </svg>
    </button>
                    </div>
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                ...
                <!--Submit Button-->
                <button class="border-2 p-4 mt-2 rounded-xl border-blue-800 text-2xl font-bold text-white shadow bg-blue-800 hover:bg-white hover:text-blue-800" @click="send_everything">
                                        Send to ePurveyors
                                    </button>
            </div>
